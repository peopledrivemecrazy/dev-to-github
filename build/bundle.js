...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(code, "class", "svelte-1tp8m2l");
    			add_location(code, file, 59, 51, 1237);
    			attr_dev(p, "class", "py-2");
    			add_location(p, file, 59, 0, 1186);
    			attr_dev(textarea, "name", "md");
    			attr_dev(textarea, "id", "mdData");
    			attr_dev(textarea, "cols", "30");
    			textarea.value = textarea_value_value = "# " + /*data*/ ctx[2].name + "\n" + /*data*/ ctx[2].summary + "\n<hr>\n\n### 📝 Latest articles from [dev.to](https://dev.to/shriji) \t\n" + /*list*/ ctx[1]() + "\n\n";
    			attr_dev(textarea, "class", "svelte-1tp8m2l");
    			add_location(textarea, file, 60, 0, 1264);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*data, list*/ 6 && textarea_value_value !== (textarea_value_value = "# " + /*data*/ ctx[2].name + "\n" + /*data*/ ctx[2].summary + "\n<hr>\n\n### 📝 Latest articles from [dev.to](https://dev.to/shriji) \t\n" + /*list*/ ctx[1]() + "\n\n")) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 55, 0, 1080);
    			add_location(button, file, 56, 0, 1122);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [username, list, data, handleClick, input_input_handler];
    }
