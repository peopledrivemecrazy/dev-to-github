...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t0 = text("Copy this to your github profile's\n      ");
    			code = element("code");
    			code.textContent = "README.md";
    			t2 = space();
    			...
    			t4 = text("\n      Copy");
    			attr_dev(code, "class", "svelte-4er5ny");
    			add_location(code, file, 90, 6, 2359);
    			attr_dev(p, "class", "py-2");
    			add_location(p, file, 88, 4, 2295);
    			attr_dev(textarea, "name", "md");
    			attr_dev(textarea, "id", "mdData");

    			textarea.value = textarea_value_value = "" + ((/*taData*/ ctx[2]
    			? /*taData*/ ctx[2]
    			: `incomplete profile </3`) + /*articleList*/ ctx[3] + /*stats*/ ctx[4] + "\n    ");

    			attr_dev(textarea, "class", "svelte-4er5ny");
    			add_location(textarea, file, 92, 4, 2395);
    			attr_dev(path, "fill-rule", "evenodd");
    			attr_dev(path, "d", "M2 13h4v1H2v-1zm5-6H2v1h5V7zm2 3V8l-3 3 3 3v-2h5v-2H9zM4.5 9H2v1h2.5V9zM2 12h2.5v-1H2v1zm9 1h1v2c-.02.28-.11.52-.3.7-.19.18-.42.28-.7.3H1c-.55 0-1-.45-1-1V4c0-.55.45-1 1-1h3c0-1.11.89-2 2-2 1.11 0 2 .89 2 2h3c.55 0 1 .45 1 1v5h-1V6H1v9h10v-2zM2 5h8c0-.55-.45-1-1-1H8c-.55 0-1-.45-1-1s-.45-1-1-1-1 .45-1 1-.45 1-1 1H3c-.55 0-1 .45-1 1z");
    			add_location(path, file, 104, 8, 2751);
    			attr_dev(svg, "title", "Copy to clipboard");
    			attr_dev(svg, "class", "octicon octicon-clippy");
    			attr_dev(svg, "viewBox", "0 0 14 16");
    			attr_dev(svg, "version", "1.1");
    			attr_dev(svg, "width", "14");
    			attr_dev(svg, "height", "16");
    			attr_dev(svg, "aria-hidden", "true");
    			add_location(svg, file, 96, 28, 2548);
    			add_location(button, file, 96, 4, 2524);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", copy, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*taData, articleList, stats*/ 28 && textarea_value_value !== (textarea_value_value = "" + ((/*taData*/ ctx[2]
    			? /*taData*/ ctx[2]
    			: `incomplete profile </3`) + /*articleList*/ ctx[3] + /*stats*/ ctx[4] + "\n    "))) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 75, 4, 1990);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "username");
    			attr_dev(input, "placeholder", "dev.to username or type ben");
    			input.required = true;
    			attr_dev(input, "class", "svelte-4er5ny");
    			add_location(input, file, 76, 4, 2019);
    			attr_dev(button, "type", "submit");
    			add_location(button, file, 84, 4, 2202);
    			add_location(form, file, 74, 2, 1979);
    			add_location(main, file, 73, 0, 1970);
    			add_location(span, file, 112, 2, 3219);
    			attr_dev(a, "href", "https://anoram.com");
    			add_location(a, file, 113, 2, 3239);
    			attr_dev(footer, "class", "text-center");
    			add_location(footer, file, 111, 0, 3188);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*handleClick*/ ctx[5], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const change_handler = () => $$invalidate(1, data = false);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("taData" in $$props) $$invalidate(2, taData = $$props.taData);
