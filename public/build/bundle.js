    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file, 86, 24, 1947);
    			add_location(button, file, 86, 0, 1923);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "placeholder", "Your dev.to username");
    			input.required = true;
    			add_location(input, file, 70, 2, 1403);
    			attr_dev(button, "type", "submit");
    			add_location(button, file, 72, 2, 1506);
    			add_location(form, file, 68, 1, 1393);
    			add_location(main, file, 66, 0, 1384);
    			add_location(span, file, 91, 1, 2526);
    			attr_dev(a, "href", "https://anoram.com");
    			add_location(a, file, 91, 19, 2544);
    			attr_dev(footer, "class", "text-center");
    			add_location(footer, file, 90, 0, 2496);
    		},
